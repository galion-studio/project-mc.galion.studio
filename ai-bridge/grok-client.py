#!/usr/bin/env python3
"""
Grok-4 Fast API Client
Ultra-fast AI client for xAI Grok API with <1 second response times

Features:
- xAI Grok-4-fast model integration
...
class GrokClient:
    ...
    def __init__(
        ...
        Args:
            ...
            model: Model to use (grok-beta for fast responses)
...
async def test_grok_client():
    ...
    if not api_key or api_key == "your-xai-api-key-here":
        print("⚠️  ERROR: XAI_API_KEY not set in .env.grok")
